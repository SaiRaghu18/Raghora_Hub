  ...
  return (
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-col footer-brand">
          <div className="footer-logo">
            ...
            />
            <span className="footer-logo-text">Raghora Hub</span>
          </div>
          <p className="footer-tagline">
            Your one-stop destination for the best tech products at unbeatable prices. Shop smarter, live better.
          </p>
          <div className="footer-social">
            ...
            <a href="#" className="social-link" title="Twitter / X" aria-label="Twitter">
      ...
      <div className="footer-bottom">
        <p>&copy; {currentYear} Raghora Hub. All rights reserved. Built with ❤️ by Raghu</p>
      </div>
    </footer>
  );
}
